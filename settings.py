...
PARALLEL = 8                                # how many process is used for tallying (Experiments show that 1 is the fastest)
...
WN_SUMMARY = True    # Make an embedding-based summary of the formulas during visualization
