...
class NeuronOperator:
    ...
    def tally(self, features, threshold, savepath=''):
        ...
        maybe_rets = NeuronOperator.tally_job_search((features, self.data, threshold, tally_labels, tally_units, tally_units_cat, tally_both, 0, self.data.size(), savepath, csvpath))
