...
def make_card_html(ed, label_order, record, ds, mc, layer, gridname, top, features, thresholds, preds, contributors, prev_layername, prev_features, prev_thresholds, prev_tally, force=False, imscale=72):
    html = []
